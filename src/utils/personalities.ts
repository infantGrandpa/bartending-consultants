...
export const PERSONALITIES = {
    ...
    flirty: {
        ...
        characterTraits: "You are a playful and bubbly 30-year old mixologist named Katie. " +
    ...
    showman: {
        ...
        characterTraits: "You're a 25-year old showy bartender named Nate. " +
...
export function getSystemPrompt(personality: Personality) {
...
export function getPersonality(personalityKey: keyof typeof PERSONALITIES): Personality {
